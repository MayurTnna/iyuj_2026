...
export const REALMS: Record<RealmId, RealmDefinition> = {
    'first-rhythm': {
        ...
        coordinates: [-240, 140, -180],
        cameraPosition: [-240, 155, -90],
        targetLookAt: [-240, 140, -180],
        color: '#F59E0B',
    ...
    'retina': {
        ...
        coordinates: [-140, -150, -260],
        cameraPosition: [-140, -140, -170],
        targetLookAt: [-140, -150, -260],
        color: '#60A5FA',
    ...
    'river': {
        ...
        coordinates: [240, 150, -220],
        cameraPosition: [240, 165, -130],
        targetLookAt: [240, 150, -220],
        color: '#06B6D4',
    ...
    'rose': {
        ...
        coordinates: [280, -50, -280],
        cameraPosition: [280, -35, -190],
        targetLookAt: [280, -50, -280],
        color: '#F43F5E',
    ...
    'silent-language': {
        ...
        coordinates: [-300, -70, -340],
        cameraPosition: [-300, -55, -250],
        targetLookAt: [-300, -70, -340],
        color: '#A855F7',
        ...
        bollywoodLyric: {
            song: 'Isharon Isharon Mein Dil Lenewale',
            film: 'Kashmir Ki Kali',
            artists: 'Asha Bhosle & Mohammed Rafi',
            line: '“Isharon isharon mein dil lene wale, bata ye hunar tune sikha kahan se... Nigaahon nigaahon mein jaadu chalana...”',
            meaning: 'Through subtle gestures and unspoken glances, you understood the secret frequency of my heart before words even formed.'
        }
    },
    ...
    'radiance': {
        ...
        coordinates: [-130, 70, -290],
        cameraPosition: [-130, 85, -200],
        targetLookAt: [-130, 70, -290],
        color: '#FBBF24',
    ...
    'sanctuary': {
        ...
        coordinates: [120, -70, -320],
        cameraPosition: [120, -55, -230],
        targetLookAt: [120, -70, -320],
        color: '#34D399',
    ...
    'missed-days': {
        ...
        coordinates: [140, -190, -380],
        cameraPosition: [140, -175, -290],
        targetLookAt: [140, -190, -380],
        color: '#64748B',
    ...
    'ascent': {
        ...
        coordinates: [0, 250, -340],
        cameraPosition: [0, 265, -240],
        targetLookAt: [0, 250, -340],
        color: '#EAB308',
        ...
        bollywoodLyric: {
            song: 'Move - Yeh Ishq Ishq',
            film: 'Dhurandhar',
            artists: 'Afsana Khan, Vishal Dadlani & Rochak Kohli',
            line: '“Ishq ishq... Yeh ishq ishq hai ishq ishq... Dum todti aashiqui ko nayi jaan de de!”',
            meaning: 'An electrifying surge of passion and relentless drive—channeling boundless energy to conquer every peak with royal fire.'
        }
    },
    ...
    'queen': {
        ...
        coordinates: [0, 0, -430],
        cameraPosition: [0, 15, -270],
        targetLookAt: [0, 0, -430],
        color: '#FFD700',
        emissiveColor: '#B45309',
        accentColor: '#FFF8DC',
        icon: '👑',
